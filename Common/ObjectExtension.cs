...
namespace WebApplication7.Common
{
    public static class ObjectExtension
    {
        ...
        /// 对象映射 ToMap，简单属性拷贝
        /// </summary>
        public static TTarget ToMap<TTarget>(this object source) where TTarget : new()
        {
        ...
        /// List集合映射
        /// </summary>
        public static List<TTarget> ToMap<TTarget>(this IEnumerable<object> source) where TTarget : new()
        {
            return source?.Select(item => item.ToMap<TTarget>()).ToList() ?? new List<TTarget>();
        }
